...
export type CanadaFormat = Hash2Format;
export type CanadaPlan = Hash2Plan;
export type CanadaConfig = Hash2Config;
export type CanadaAlert = Hash2Alert;
export type CanadaPlanRuntime = Hash2PlanRuntime;
export type CanadaRuntime = Hash2Runtime;
